				...
				<div class="text text-center">
					...
					<h2>
						<span class="txt-rotate" data-period="2000"
							data-rotate='[ "A Web Designer.", "A Web Developer.", "A Mobile Android App.", "An Enterpreneur.", "A Blogger" ]'>
						</span>
					</h2>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
				<div class="row justify-content-start pb-3">
					<div class="col-md-12 heading-section ftco-animate">
						...
						<h2 class="mb-4">All Just Me Here</h2>
						<p>I am well dedicated and diligent in my job. My works and Projects are done within the given
							time frame. Simplicity is key and Patience is the virtue.</p>
						<ul class="about-info mt-4 px-md-0 px-2">
							<li class="d-flex"><span>Name:</span> <span>Balogun Gift</span></li>
							<li class="d-flex"><span>Date of birth:</span> <span>May 13, 1999</span></li>
							<li class="d-flex"><span>Address:</span> <span>Covenant University, Ota, Ogun State</span>
							</li>
							<li class="d-flex"><span>Zip code:</span> <span>112233</span></li>
							<li class="d-flex"><span>Email:</span> <span>balogunigift@gmail.com</span></li>
							<li class="d-flex"><span>Phone: </span> <span>+234-802-723-7396</span></li>
						</ul>
					</div>
				</div>
			...
			<div class="col-md-9">
				...
				<div id="page-3" class="page three">
					...
					<div class="row progress-circle mb-5">
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Enterpreneur</h2>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Android Dev</h2>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Laravel Developer</h2>
								<div class="progress mx-auto" data-value='79'>
									<span class="progress-left">
										<span class="progress-bar border-primary"></span>
									</span>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Forex Trader</h2>
								<div class="progress mx-auto" data-value='79'>
									<span class="progress-left">
										<span class="progress-bar border-primary"></span>
									</span>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Data Analyst</h2>
								<div class="progress mx-auto" data-value='79'>
									<span class="progress-left">
										<span class="progress-bar border-primary"></span>
									</span>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								<h2 class="h5 font-weight-bold text-center mb-4">Python Developer</h2>
								<div class="progress mx-auto" data-value='79'>
									<span class="progress-left">
										<span class="progress-bar border-primary"></span>
									</span>
						...
						<div class="col-lg-4 mb-4">
							<div class="bg-white rounded-lg shadow p-4">
								...
								<div class="progress mx-auto" data-value='79'>
									...
									<div
										class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
										<div class="h2 font-weight-bold">88<sup class="small">%</sup></div>
									</div>
								</div>
								<!-- END -->
	...
	<div class="container-fluid px-md-5">
		<div class="row justify-content-center py-5 mt-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<h1 class="big big-2">What I Do</h1>
...
<section class="ftco-section ftco-project" id="projects-section">
	<div class="container-fluid px-md-0">
		<div class="row no-gutters justify-content-center pb-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<h1 class="big big-2">My Works So Far</h1>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-7 ftco-animate text-center">
				<h2>I'm <span>Available</span> for <span>freelancing</span> or <span>Collabroations?</span></h2>
				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
				<a href="#contact-section"><button class="btn btn-primary py-3 px-5">Hire me</button></a>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-md-6 col-lg-3 d-flex ftco-animate">
				<div class="align-self-stretch box text-center p-4 shadow">
					...
					<div>
						...
						<p><a href="mailto:balogunigift@gmail.com">balogunigift@gmail.com</a></p>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 d-flex ftco-animate">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2>Thank you</h2>
					<p>Your message is successfully sent to me...</p>
				</div>
			</div>
		</div>
	</div>
